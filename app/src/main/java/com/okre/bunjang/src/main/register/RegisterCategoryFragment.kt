...
import com.okre.bunjang.databinding.FragmentRegisterCategoryBinding

class RegisterCategoryFragment : BaseFragment<FragmentRegisterCategoryBinding>(FragmentRegisterCategoryBinding::bind, R.layout.fragment_register_category) {
